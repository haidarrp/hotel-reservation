...
<body class="">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" action="/login" method="post">
                    ...
                    <div class="mb-3">
                      <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" value="{{old('password')}}" placeholder="Password" aria-label="Password" aria-describedby="password-addon" required>
                      @error('password')
                      <div class="invalid-feedback">
                        {{$message}}
                      </div>
  ...
  {{-- Modal --}}
  <div class="modal fade" id="modalError" aria-hidden="true" aria-labelledby="modalSuccess" tabindex="-1">
